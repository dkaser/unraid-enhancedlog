 ...
 *   https://datatables.net/download/#ju/dt-2.3.2/b-3.2.4/b-html5-3.2.4/cc-1.0.6/date-1.5.6/rg-1.5.2/sr-1.4.1
 *
 * Included libraries:
 *   DataTables 2.3.2, Buttons 3.2.4, HTML5 export 3.2.4, ColumnControl 1.0.6, DateTime 1.5.6, RowGroup 1.5.2, StateRestore 1.4.1
 */
...
(function (factory) {
  ...
  DataTable.ext = _ext = {
     ...
     */
    builder:
      "ju/dt-2.3.2/b-3.2.4/b-html5-3.2.4/cc-1.0.6/date-1.5.6/rg-1.5.2/sr-1.4.1",
            ...
            layout: {
              ...
              hLineColor: function (i, node) {
                return i === node.table.headerRows ||
                  i === node.table.body.length - node.table.footerRows
                  ? "#333"
                  : "#ddd";
              },
...
(function (factory) {
  ...
  var icons = {
    ...
    // Custom
    contains: wrap(
      '<path d="M10 3h4v18h-4z"/><path d="M18 8h3v9h-3"/><path d="M6 17H3V8h3"/>'
    ),
    ...
    notEqual: wrap(
      '<path d="M5 9h14"/><path d="M5 15h14"/><path d="M15 5 9 19"/>'
    ),
    // Custom
    orderAddAsc: wrap(
  ...
  var dropdownContent = {
    ...
    init: function (config) {
      var dt = this.dt();
      var dropdown = createElement(
        "div",
        dropdownContent.classes.container,
        "",
      ...
      dropdown.setAttribute(
        "aria-label",
        dt.i18n("columnControl.dropdown", config.text)
      );
      ...
      dt.on("fixedheader-mode", function () {
        if (dropdown._shown) {
          attachDropdown(
            dropdown,
            dt,
            config._parents ? config._parents[0] : btn
          );
        }
      });
  ...
  var Button = /** @class */ (function () {
    ...
    Button.prototype._checkActive = function () {
      if (
        this._s.active === true ||
        Object.values(this._s.activeList).includes(true)
      ) {
  ...
  var order = {
    ...
    init: function (config) {
      ...
      dt.on("order", function (e, s, order) {
        var found = order.find(function (o) {
  ...
  var orderAddAsc = {
    ...
    init: function (config) {
      ...
      dt.on("order", function (e, s, order) {
        var found = order.some(function (o) {
          return o.col === _this.idx();
        });
        btn.enable(!found);
      });
    ...
    init: function (config) {
      ...
      var btn = new Button(dt)
        ...
        .handler(function () {
          ...
          var order = dt.order();
          var idx = order.findIndex(function (o) {
        ...
        (_b =
          (_a =
            state === null || state === void 0
              ? void 0
              : state.columnControl) === null || _a === void 0
            ? void 0
            : _a[idx]) === null || _b === void 0
          ? void 0
          : _b.searchInput;
      if (loadedState) {
    ...
    init: function (config) {
      ...
      var searchInput = new SearchInput(dt, this.idx())
        ...
        .options([
          ...
          {
            label: dt.i18n(i18nBase + "notEqual", "Does not equal"),
            value: "notEqual",
          },
          ...
          {
            label: dt.i18n(i18nBase + "notEmpty", "Not empty"),
            value: "notEmpty",
          },
        ])
        .search(function (searchType, searchTerm, loadingState) {
          ...
          if (searchType === "empty") {
            ...
            column.search.fixed("dtcc", function (haystack) {
              return (
                dateToNum(haystack, displayFormat, moment, luxon) == search
              );
            });
            ...
            column.search.fixed("dtcc", function (haystack) {
              return dateToNum(haystack, displayFormat, moment, luxon) > search;
            });
  ...
  function getState(columnIdx, state) {
    ...
    var loadedState =
      (_b =
        (_a =
          state === null || state === void 0 ? void 0 : state.columnControl) ===
          null || _a === void 0
          ? void 0
          : _a[columnIdx]) === null || _b === void 0
        ? void 0
        : _b.searchList;
    if (loadedState) {
      return loadedState;
  ...
  function getJsonOptions(dt, idx) {
    var _a;
    var json =
      (_a = dt.ajax.json()) === null || _a === void 0
        ? void 0
        : _a.columnControl;
  ...
  var searchList = {
    ...
    init: function (config) {
      ...
      var applySearch = function (values) {
        ...
        if (config._parents) {
          config._parents.forEach(function (btn) {
            return btn.activeList(_this.unique(), !!values.length);
          });
        }
      };
      var checkList = new CheckList(dt, {
    ...
    init: function (config) {
      ...
      var searchInput = new SearchInput(dt, this.idx())
        ...
        .options([
          ...
          {
            label: dt.i18n(i18nBase + "greater", "Greater than"),
            value: "greater",
          },
          {
  ...
  var searchText = {
    ...
    init: function (config) {
      ...
      var searchInput = new SearchInput(dt, this.idx())
        ...
        .options([
          {
            label: dt.i18n(i18nBase + "contains", "Contains"),
            value: "contains",
          },
          {
  ...
  var search = {
    ...
    init: function (config) {
      ...
      var loadedState =
        (_c =
          (_b =
            (_a = dt.state.loaded()) === null || _a === void 0
              ? void 0
              : _a.columnControl) === null || _b === void 0
            ? void 0
            : _b[idx]) === null || _c === void 0
          ? void 0
          : _c.searchInput;
      var initType = function (type) {
        ...
        if (config.allowSearchList && json) {
          ...
          return searchList.init.call(
            _this,
            Object.assign({}, searchList.defaults, config)
          );
          ...
          // Everything else
          return searchText.init.call(
            _this,
            Object.assign({}, searchText.defaults, config)
          );
        }
      };
  ...
  var ColumnControl = /** @class */ (function () {
    ...
    function ColumnControl(dt, columnIdx, opts) {
      ...
      if (this._c.content) {
        ...
        dt.on("columns-reordered", function (e, details) {
          _this._s.columnIdx = dt.colReorder.transpose(
            originalIdx,
            "fromOriginal"
          );
        });
    ...
    ColumnControl.prototype.resolve = function (content) {
      ...
      if (typeof content === "string") {
        ...
        config = Object.assign(
          {},
          plugin === null || plugin === void 0 ? void 0 : plugin.defaults
        );
  ...
  $.extend(DateTime.prototype, {
    ...
    _optionsTime: function (unit, count, val, allowed, range) {
      ...
      if (count === 12) {
        ...
        var start =
          range !== null ? range : val === -1 ? 0 : Math.floor(val / 10) * 10;
    ...
    _optionsTitle: function () {
      ...
      this.dom.previous
        ...
        .children("button")
        .text(i18n.previous);
      this.dom.next.attr("title", i18n.next).children("button").text(i18n.next);
    },
...
(function (factory) {
  ...
  (function () {
    ...
    var StateRestore = /** @class */ (function () {
      function StateRestore(
        ...
        this.s = {
          ...
          savedState: null,
          tableId:
            state && state.stateRestore
              ? state.stateRestore.tableId
              : undefined,
        };
        this.dom = {
          background: $$2('<div class="' + this.classes.background + '"/>'),
          closeButton: $$2(
            '<div class="' + this.classes.closeButton + '">&times;</div>'
          ),
      ...
      StateRestore.prototype.remove = function (skipModal) {
        ...
        var ajaxData = {
          action: "remove",
          stateRestore:
            ((_a = {}), (_a[this.s.identifier] = this.s.savedState), _a),
        };
        ...
        if (!this.c.ajax) {
          removeFunction = function () {
            try {
              ...
              _this.dom.confirmation
                .children("." + _this.classes.modalError)
                .remove();
      ...
      StateRestore.prototype.load = function () {
        ...
        var loaded = function () {
          var correctPaging = function (e, preSettings) {
            setTimeout(function () {
              var currpage =
                preSettings._iDisplayStart / preSettings._iDisplayLength;
       ...
       */
      StateRestore.prototype.rename = function (
        newIdentifier,
        currentIdentifiers
      ) {
        var _this = this;
        ...
        var renameFunction = function () {
          ...
          if (newIdentifier === null) {
            var tempIdentifier = $$2(
              "input." + _this.classes.input.replace(/ /g, ".")
            ).val();
          ...
          var ajaxData = {
            action: "rename",
            stateRestore:
              ((_a = {}), (_a[_this.s.identifier] = newIdentifier), _a),
          };
          var successCallback = function () {
            ...
            _this.dom.removeContents = $$2(
              '<div class="' +
                _this.classes.confirmationText +
                '"><span>' +
                _this.s.dt
                  .i18n(
                    "stateRestore.removeConfirm",
                    _this.c.i18n.removeConfirm
                  )
          ...
          if (!_this.c.ajax) {
            ...
            typeof _this.c.ajax === "string" &&
            _this.s.dt.settings()[0]._bInitComplete
          ) {
            $$2.ajax({
              data: ajaxData,
              success: successCallback,
       ...
       */
      StateRestore.prototype.save = function (
        state,
        ...
        if (this.c.saveState.columns && this.s.savedState.columns) {
          for (
            var i = 0, ien = this.s.savedState.columns.length;
            i < ien;
            i++
          ) {
            // Visibility
        ...
        if (this.s.savedState.c.splitSecondaries.length) {
          for (
            var _i = 0, _b = this.s.savedState.c.splitSecondaries;
            _i < _b.length;
            _i++
          ) {
            var secondary = _b[_i];
      ...
      StateRestore.prototype._deepCompare = function (state1, state2) {
        ...
        for (i = 0; i < keys[0].length; i++) {
          ...
          if (typeof states[0][keys[0][i]] === "object") {
            if (
              !this._deepCompare(states[0][keys[0][i]], states[1][keys[1][i]])
            ) {
              return false;
            }
          } else if (
            typeof states[0][keys[0][i]] === "number" &&
            typeof states[1][keys[1][i]] === "number"
          ) {
            if (
              Math.round(states[0][keys[0][i]]) !==
              Math.round(states[1][keys[1][i]])
            ) {
              return false;
            }
          }
       ...
       */
      StateRestore.prototype._newModal = function (
        title,
        buttonText,
        buttonAction,
        modalContents
        ...
        var background = $$2(
          "div." + this.classes.background.replace(/ /g, ".")
        );
    ...
    var StateRestoreCollection = /** @class */ (function () {
       ...
       */
      StateRestoreCollection.prototype.addState = function (
        identifier,
        currentIdentifiers,
        options
      ) {
        ...
        var createFunction = function (id, toggles) {
          ...
          if (toggles.saveState) {
            ...
            for (
              var _i = 0, _a = Object.keys(toggles.saveState);
              _i < _a.length;
              _i++
            ) {
              var key = _a[_i];
              if (typeof toggles.saveState[key] === "object") {
                for (
                  var _b = 0, _c = Object.keys(toggles.saveState[key]);
                  _b < _c.length;
                  _b++
                ) {
                  var nestedKey = _c[_b];
          ...
          var newState = new StateRestore(
            _this.s.dt.settings()[0],
            $$1.extend(true, {}, _this.c, options),
            id,
            currState,
            false,
            successCallback
        ...
        if (state === null) {
          if (
            this.c.creationModal ||
            (options !== undefined && options.creationModal)
          ) {
      ...
      StateRestoreCollection.prototype.removeAll = function (removeFunction) {
        ...
        $$1(this.dom.removeContents.children("span")).html(
          this.s.dt
            .i18n("stateRestore.removeConfirm", this.c.i18n.removeConfirm)
      ...
      StateRestoreCollection.prototype.findActive = function () {
        ...
        for (var _i = 0, buttons_1 = buttons; _i < buttons_1.length; _i++) {
          button = buttons_1[_i];
          if (
            $$1(button).hasClass("dtsr-state") ||
            $$1(button).children().hasClass("dtsr-state")
          ) {
      ...
      StateRestoreCollection.prototype._collectionRebuild = function () {
        ...
        if (this.s.states.length === 0) {
          ...
          for (var _i = 0, _a = this.s.states; _i < _a.length; _i++) {
            ...
            if (
              split.includes("updateState") &&
              (!this.c.save || !state.c.save)
            ) {
            ...
            if (
              split.includes("removeState") &&
              (!this.c.remove || !state.c.remove)
            ) {
       ...
       */
      StateRestoreCollection.prototype._creationModal = function (
        buttonAction,
        identifier,
        options
      ) {
        ...
        var togglesToInsert = [];
        var toggleDefined =
          options !== undefined && options.toggle !== undefined;
        // Order toggle - check toggle and saving enabled
        if (
          (((!toggleDefined || options.toggle.order === undefined) &&
            this.c.toggle.order) ||
        ...
        if (
          (((!toggleDefined || options.toggle.search === undefined) &&
        ...
        if (
          (((!toggleDefined || options.toggle.length === undefined) &&
            this.c.toggle.length) ||
        ...
        if (
          ...
          (((!toggleDefined || options.toggle.colReorder === undefined) &&
            this.c.toggle.colReorder) ||
        ...
        if (
          this.s.hasScroller &&
          (((!toggleDefined || options.toggle.scroller === undefined) &&
            this.c.toggle.scroller) ||
        ...
        if (
          ...
          (((!toggleDefined || options.toggle.searchBuilder === undefined) &&
        ...
        if (
          ...
          (((!toggleDefined || options.toggle.searchPanes === undefined) &&
            this.c.toggle.searchPanes) ||
        ...
        if (
          this.s.hasSelect &&
          (((!toggleDefined || options.toggle.select === undefined) &&
            this.c.toggle.select) ||
        ...
        if (
          ...
          ((!toggleDefined || options.toggle.columns === undefined) &&
            typeof this.c.toggle.columns !== "boolean") ||
        ...
        // 	.appendTo(this.dom.creationForm);
        for (
          var _i = 0, togglesToInsert_1 = togglesToInsert;
          _i < togglesToInsert_1.length;
          _i++
        ) {
        ...
        for (
          var _a = 0, togglesToInsert_2 = togglesToInsert;
          _a < togglesToInsert_2.length;
          _a++
        ) {
          ...
          $$1(toggle.children("label:last-child")).on("click", function () {
            toggle
              .children("input")
              .prop("checked", !toggle.children("input").prop("checked"));
          });
        }
        var creationButton = $$1(
          "button." + this.classes.creationButton.replace(/ /g, ".")
        );
        ...
        creationButton.on("click", function () {
          ...
          var saveState = {
            ...
            columns: {
              search: _this.dom.columnsSearchToggle
                .find("input")
                .is(":checked"),
              visible: _this.dom.columnsVisibleToggle
                .find("input")
                .is(":checked"),
            },
            ...
            searchBuilder: _this.dom.searchBuilderToggle
              .find("input")
              .is(":checked"),
            searchPanes: _this.dom.searchPanesToggle
              .find("input")
              .is(":checked"),
          ...
          var success = buttonAction(
            $$1("input." + _this.classes.nameInput.replace(/ /g, ".")).val(),
            { saveState: saveState }
          );
          if (success === true) {
       ...
       * @param modalContents The contents for the main body of the modal
       */
      StateRestoreCollection.prototype._newModal = function (
        title,
        buttonText,
        buttonAction,
        modalContents
      ...
      StateRestoreCollection.prototype._searchForStates = function () {
        ...
        var _loop_2 = function (key) {
          ...
          if (
            ...
            if (
              loadedState_1.stateRestore.isPreDefined ||
            ...
            var newState_1 = new StateRestore(
              this_2.s.dt,
              $$1.extend(true, {}, this_2.c, {
                saveState: loadedState_1.c.saveState,
              }),
              loadedState_1.stateRestore.state,
              loadedState_1,
              false,
              successCallback
            );
            $$1(this_2.s.dt.table().node()).on(
              "dtsr-modal-inserted",
              function () {
    ...
    DataTable.ext.buttons.stateRestore = {
      ...
      text: function (dt) {
        return dt.i18n(
          ...
          "State %d",
          dt.stateRestore.states()[0].length + 1
        );
      },
    };
    ...
    DataTable.ext.buttons.createState = {
      action: function (e, dt, node, config) {
        ...
        var defaultString =
          language.buttons !== undefined &&
          language.buttons.stateRestore !== undefined
        ...
        if (defaultString.indexOf("%d") === defaultString.length - 3) {
          ...
          replaceRegex = [];
          for (
            var _i = 0, splitString_1 = splitString;
            _i < splitString_1.length;
            _i++
          ) {
        ...
        var getId = function (identifier) {
          ...
          if (Array.isArray(replaceRegex)) {
            id = identifier;
            for (
              var _i = 0, replaceRegex_1 = replaceRegex;
              _i < replaceRegex_1.length;
              _i++
            ) {
        ...
        dt.stateRestore.state.add(
          dt.i18n(
            "buttons.stateRestore",
            "State %d",
            lastNumber !== undefined ? lastNumber + 1 : 1
          ),
          config.config
        );
        ...
        var stateButtons =
          button[0] !== undefined &&
          button[0].inst.c.buttons[0].buttons !== undefined
      ...
      init: function (dt, node, config) {
        if (
          dt.settings()[0]._stateRestore === undefined &&
          dt.button("SaveStateRestore:name").length > 1
        ) {
          _buttonInit(dt, config);
        }
      },
    ...
    DataTable.ext.buttons.removeAllStates = {
      ...
      init: function (dt, node) {
        if (
          !dt.settings()[0]._stateRestore ||
          dt.stateRestore.states().length === 0
        ) {
    ...
    $(document).on("preInit.dt.dtsr", function (e, settings) {
      ...
      if (settings.oInit.stateRestore || DataTable.defaults.stateRestore) {
...
(function (factory) {
  ...
  $.extend(true, DataTable.StateRestore.classes, {
    ...
    confirmationButton:
      "dtsr-confirmation-button ui-button ui-state-default ui-button-text-only ui-corner-all ui-widget",
  });
